...
#    i2c = None
    ...
    def read(self):
            ...
            sensor_data =  self.i2c.readList(self.__PX4FLOW_FRAME_COUNT, 26)  # 22 if not using the integral registers

            #x_velocity = self.i2c.readS16(self.__PX4FLOW_FLOW_COMP_M_X)

            #y_velocity = self.i2c.readS16(self.__PX4FLOW_FLOW_COMP_M_Y)
